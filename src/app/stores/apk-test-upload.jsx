...
const {APKTestUploadActions} = require('../actions/');

// Store
const APKTestUploadStore = Reflux.createStore({

	// Base Store //

	listenables: APKTestUploadActions,
...
module.exports = APKTestUploadStore;
