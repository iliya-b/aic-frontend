...
const ToolbarGPS = class extends React.Component {
	...
	constructor(props) {
		...
		this.handleClick = e => {
			const payload = {
				relative_humidity: parseFloat(this.humidity.getValue())
			};
	...
	render() {
		...
		return (
			<Paper style={Object.assign(this.props.style, styles.paper)} zDepth={1}>
				...
				<TextField style={styles.items} ref={this.setRefHumidity} hintText="humidity" onFocus={this.props.onInputFocus} onBlur={this.props.onInputBlur}/>
				<RaisedButton
					label="Submit"
					title="Submit"
					href="#"
