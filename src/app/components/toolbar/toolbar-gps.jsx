	...
	render() {
		...
		return (
			<Paper style={Object.assign(this.props.style, styles.paper)} zDepth={1}>
				...
				<TextField style={styles.items} ref={this.setRefLat} hintText="latitude" onFocus={this.props.onInputFocus} onBlur={this.props.onInputBlur}/>
				<TextField style={styles.items} ref={this.setRefLon} hintText="longitude" onFocus={this.props.onInputFocus} onBlur={this.props.onInputBlur}/>
				<RaisedButton
					label="Submit"
					title="Submit"
					href="#"
