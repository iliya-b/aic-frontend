	...
	render() {
		...
		return (
			<div>
				...
				<ClearFix>
					<h2>Panel Progress</h2>
					<PanelProgress style={{margin: 10, width: 800}} items={items1}/>
					<br/>
					<PanelProgress style={{margin: 10, width: 400}} items={items1}/>
					<br/>
					<PanelProgress style={{margin: 10, width: '95%'}} items={items1}/>
					<br/>
					<PanelProgress style={{margin: 10, width: 800}} items={items2}/>
					<br/>
					<PanelProgress style={{margin: 10, width: 800}} items={items3}/>
					<br/>
					<PanelProgress style={{margin: 10, width: 800}} items={items4}/>
					<br/>
